...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f2836252-97df-4e2a-8833-255259853858
```

> `f2836252-97df-4e2a-8833-255259853858` is the password of the certificate, you can change it to any password you want.
